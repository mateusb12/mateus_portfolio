...
const imageModules = import.meta.glob('../../assets/img/skills_icons/*.png', { eager: true });

const skillsIcons = Object.keys(imageModules).reduce((acc, path) => {
    const iconName = path
        .split('/')
        .pop()
        .replace('.png', '');
    acc[iconName] = imageModules[path].default;
    return acc;
}, {});
